...
internal class ClientSocket constructor(var tracer: TraceCollector = TraceCollector.instance) {
    ...
    private fun makeHTTPCommand(url: URL, headers: Map<String, String>?, operator: String?, cookies: ArrayList<HttpCookie>?, requestId: String?): String {
        val CRLF = "\r\n"
        val cmd = StringBuffer()
    ...
    private fun sendCommand(url: URL, headers: Map<String, String>?, operator: String?, cookies: ArrayList<HttpCookie>?, requestId: String?): ResultHandler? {
